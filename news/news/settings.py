...
ACCOUNT_EMAIL_VERIFICATION = 'none' # Хотим ли мы чтобы пользователь подтвердил почту
...
# можно поставить время побольше, но как правило, это сильно бьёт по производительности сервера
